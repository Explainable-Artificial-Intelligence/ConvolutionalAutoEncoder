...
class ClusterParameters(Model):
    ...
    """
    def __init__(self, n_clusters: int=None, init: str=None, n_init: int=None, max_iter: int=None, tol: float=None, precompute_distances: str=None, verbose: int=None, random_state: int=None, copy_x: bool=None, n_jobs: int=None, algorithm: str=None):
        """
    ...
    def from_dict(cls, dikt) -> 'ClusterParameters':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The ClusterParameters of this ClusterParameters.
