  ...
  assert(!err);
    ...
    <section class="suite">
        ...
        <dl>
            ...
            <dd>
                <pre><code>request.Part.should.be.a.function;</code></pre>
            </dd>
            <dt>should expose .protocols</dt>
            <dd><pre><code>Object.keys(request.protocols)
  .should.eql(['http:', 'https:']);</code></pre>
            </dd>
            <dt>should expose .serialize</dt>
            <dd><pre><code>Object.keys(request.serialize)
  .should.eql(['application/x-www-form-urlencoded', 'application/json']);</code></pre>
            </dd>
            <dt>should expose .parse</dt>
            <dd><pre><code>Object.keys(request.parse)
  .should.eql(['application/x-www-form-urlencoded', 'application/json', 'text', 'image']);</code></pre>
            </dd>
        </dl>
    </section>
    <section class="suite">
...
setTimeout(function(){req.abort()},50);</code></pre>
            </dd>
        </dl>
    </section>
    <section class="suite">
...
utils.type('application/json')
  .should.equal('application/json');</code></pre>
            </dd>
        </dl>
    </section>
    <section class="suite">
...
utils.params(str).should.eql({});</code></pre>
            </dd>
        </dl>
    </section>
    <section class="suite">
...
ret.last.should.equal('https://api.github.com/repos/visionmedia/mocha/issues?page=5');</code></pre>
            </dd>
        </dl>
    </section>
</div>
<a href="http://github.com/visionmedia/superagent"><img style="position: absolute; top: 0; right: 0; border: 0;"
